...
# contendo pandas e suas dependências, seguindo a estrutura correta exigida
# pelo AWS Lambda (pasta 'python' dentro do zip).
#
...
main() {
    print_step "Iniciando build do AWS Lambda Layer para pandas..."
    ...
    # 5. Instalação do pandas e dependências
    print_step "Instalando pandas e dependências..."
